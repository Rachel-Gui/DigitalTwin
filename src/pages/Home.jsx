...
function ImmersiveModeSection(){
  return <section className="home-feature-section"><div className="home-feature page-container">
    ...
    <Link className="home-feature-media" to="/vr" aria-label="Enter Immersive Mode"><img src={vrConcord} alt="Immersive PM2.5 particle visualization around Concord International School"/></Link>
  </div></section>
}
